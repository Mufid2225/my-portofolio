      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <Link
            ...
            className="flex items-center gap-3 rounded-lg border border-border/40 bg-secondary/50 p-4 text-muted-foreground transition-colors hover:text-emerald-400"
          >
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-sm">github/Mufid2225</p>
            </div>
          </Link>
          <Link
